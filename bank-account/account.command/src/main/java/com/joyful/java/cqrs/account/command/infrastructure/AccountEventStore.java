...
//    }
    ...
    public List<String> getAggregateIds() {
        Optional<List<EventModel>> eventStream = Optional.ofNullable(eventStoreRepository.findAll());
        ...
        return eventStream
                ...
                .orElseThrow(() -> new IllegalStateException("Could not retreive event stream."));
